...
import { extractLastAssistant, formatMemoryContext, recoverySessionId, VaultClient, VaultHttpError, vaultSessionId, } from "./client.js";
    ...
    for (const event of spool.pending()) {
        try {
            ...
            if (event.kind === "message") {
                ...
                try {
                    await client.appendMessage(event.session_id, event.role, event.content, event.metadata ?? {}, event.event_id);
                }
                catch (error) {
